//
//  CreateBusinessCardViewDataSource.swift
//  CoBook
//
...
class CreateBusinessCardViewDataSource: NSObject, UITableViewDataSource {

    // MARK: Properties
    var source: [CreateBusinessCard.Section] = []

    unowned var tableView: UITableView
    weak var cellsDelegate: (
    ...
    subscript(indexPath: IndexPath) -> CreateBusinessCard.Item? {
        get {
